...
def mean_shift(X, bandwidth=None, seeds=None, bin_seeding=False,
    ...
    #all_res = Parallel(verbose=5, n_jobs=n_jobs)(
    ...
    partialMs = partial(_mean_shift_single_seed, X=X, nbrs=nbrs, max_iter=max_iter)


    all_res = pool.map(partialMs, (seed for seed in seeds))
